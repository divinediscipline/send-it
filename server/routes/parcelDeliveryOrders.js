...
router.get('/parcels/:parcelId', userAuth.authenticate, checkParcelDetails, userAuth.verifyId, orderController.getOneOrder);
...
router.put('/parcels/:parcelId/status', userAuth.authenticateAdmin, checkParcelDetails, parcelValidator.validateStatusChange, orderController.changeOrderStatus);
